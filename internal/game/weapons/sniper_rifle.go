...
func SniperRifle() game.Weapon {
	weapon := game.Weapon{
		Item: game.Item{
			...
			Description: "A high-precision, long-range rifle, widely used to pick off high value targets. Expensive and rare, they are given to the best marksmen and sharpshooters.",
			Effects:     []game.Effect{},
		},
		Actions: []game.Action{
			actions.CalledShot,
		...
		Clip: 4,
		Reload: func(g *game.Game, parent *game.Actor, slot uuid.UUID) {
